...
<p align="center">
  <img src="assets/banner.svg" alt="Awesome Performance Management Banner" width="100%" />
</p>
...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](https://github.com/ishandutta2007/Awesome-Performance-Management/pulls)
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg?style=flat-square)](https://github.com/ishandutta2007/Awesome-Performance-Management/graphs/commit-activity)
...
| **[Formbricks](https://github.com/formbricks/formbricks)** | [![Stars](https://img.shields.io/github/stars/formbricks/formbricks?style=social&color=white)](https://github.com/formbricks/formbricks/stargazers) | AGPL-3.0 | TypeScript, Next.js, TailwindCSS | Open-source Qualtrics alternative perfectly suited for running anonymous 360° employee feedback, pulse surveys, manager assessments, and engagement evaluations. |
| **[Frappe HRMS](https://github.com/frappe/hrms)** | [![Stars](https://img.shields.io/github/stars/frappe/hrms?style=social&color=white)](https://github.com/frappe/hrms/stargazers) | GPL-3.0 | Python, Vue, JavaScript | Modern, dedicated open-source HR and performance management system covering comprehensive appraisal templates, continuous feedback, goal tracking, and ratings. |
| **[GLPI](https://github.com/glpi-project/glpi)** | [![Stars](https://img.shields.io/github/stars/glpi-project/glpi?style=social&color=white)](https://github.com/glpi-project/glpi/stargazers) | GPL-3.0 | PHP, JavaScript, MariaDB | Open management infrastructure providing evaluation workflows, team task tracking, compliance audits, and administrative reporting. |
| **[Horilla HRMS](https://github.com/horilla-opensource/horilla)** | [![Stars](https://img.shields.io/github/stars/horilla-opensource/horilla?style=social&color=white)](https://github.com/horilla-opensource/horilla/stargazers) | LGPL-3.0 | Python, Django, JavaScript | Modern, free, and open-source Human Resource Management software with extensible employee performance appraisal, KPI tracking, and check-in workflows. |
| **[OrangeHRM](https://github.com/OrangeHRM/orangehrm)** | [![Stars](https://img.shields.io/github/stars/OrangeHRM/orangehrm?style=social&color=white)](https://github.com/OrangeHRM/orangehrm/stargazers) | GPL-2.0 | PHP, Symfony, MySQL | Established open-source HR platform with a robust Performance module providing customizable evaluation cycles, KPI trackers, and 360-degree reviews. |
| **[Operately](https://github.com/operately/operately)** | [![Stars](https://img.shields.io/github/stars/operately/operately?style=social&color=white)](https://github.com/operately/operately/stargazers) | Apache-2.0 | Elixir, Phoenix, React, Tailwind | Open-source company operating system connecting corporate OKRs, weekly check-ins, projects, and cross-team goal progress in real time. |
| **[Thrive Goals](https://github.com/get-thriving/thrive)** | [![Stars](https://img.shields.io/github/stars/get-thriving/thrive?style=social&color=white)](https://github.com/get-thriving/thrive/stargazers) | MIT | TypeScript, Node.js, React | Modern, minimalist open-source goal and OKR tracking engine for product engineering and cross-functional teams. |
| **[Oslo Kommune OKR Tracker](https://github.com/oslokommune/okr-tracker)** | [![Stars](https://img.shields.io/github/stars/oslokommune/okr-tracker?style=social&color=white)](https://github.com/oslokommune/okr-tracker/stargazers) | MIT | Vue.js, Firebase, TypeScript | Government and civic-grade open-source web application designed to track Objectives, Key Results (OKRs), and KPIs across teams. |
| **[OpenOKR](https://github.com/OpenOKR/OpenOKR)** | [![Stars](https://img.shields.io/github/stars/OpenOKR/OpenOKR?style=social&color=white)](https://github.com/OpenOKR/OpenOKR/stargazers) | Apache-2.0 | Java, Spring Boot, MySQL | Dedicated open-source OKR platform supporting objective cascading, departmental alignment, milestone updates, and goal completion scores. |
| **[HRPulsar](https://github.com/HRPulsar/hrpulsar)** | [![Stars](https://img.shields.io/github/stars/HRPulsar/hrpulsar?style=social&color=white)](https://github.com/HRPulsar/hrpulsar/stargazers) | MIT | Python, FastAPI, Next.js | Modern talent and competency management platform supporting 360° assessments, skill frameworks, individual development plans (IDPs), and AI evaluations. |
...
```mermaid
flowchart LR
    A["🎯 Define Performance Philosophy"] --> B{"Hosting Strategy?"}
    B -->|"Commercial / Turnkey"| C["SaaS Platform Tier"]
    B -->|"Self-Hosted / Compliant"| D["Open-Source Deployment"]
    
    C --> C1["Lattice / Culture Amp<br/>(360 + People Science)"]
    C --> C2["15Five / Leapsome<br/>(Continuous 1:1s + Coaching)"]
    C --> C3["Betterworks / PerformYard<br/>(Enterprise OKRs & Workflows)"]
    
    D --> D1["Operately / OpenOKR<br/>(Dedicated OKRs & Check-ins)"]
    D --> D2["Frappe HRMS / Horilla<br/>(Full Appraisals & Core HR)"]
    D --> D3["Formbricks<br/>(Anonymous 360 & Pulse Feedback)"]
```
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Performance-Management&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Performance-Management&type=date&legend=top-left)
